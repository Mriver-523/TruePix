...
class CircuitProverNI(CircuitVerifier, metaclass=libTruePix.parse_pws.FromPWS):
    cat_label = "prv_ni"
...
class CircuitVerifierNI(CircuitVerifier, metaclass=libTruePix.parse_pws.FromPWS):
    fs = None
    cat_label = "ver_ni"
