...
class Defs(object):
    ...
    # Circuit wires use Mersenne-61; Fiat–Shamir challenges live in Fp2.
    ...
    prime = BASE_PRIME_61
    # Modular inverses (not integer division): 2*half ≡ 1, 3*third ≡ 1 (mod p).
    half = 1152921504606846976
    ...
    @classmethod
    def configure(cls, vole_security_repetitions=1):
        """Apply the (only) TruePix field / VOLE configuration."""
        cls.protocol = cls.PROTOCOL_ID
        cls.vole_security_repetitions = int(vole_security_repetitions)
        cls.prime = cls.BASE_PRIME_61
        cls.half = 1152921504606846976
        cls.third = 1537228672809129301
        cls.nbits = 61

    @classmethod
    def is_ext_field(cls):
        return True
