...
class MulGateProver(_SecondOrderGateProver):
    ...
    @staticmethod
    def v_com_gatefn_(_, __, xy, ____): # pylint: disable=unused-argument
        return xy
...
class MuxGateProver(_FirstOrderGateProver):
    ...
    @staticmethod
    def v_com_gatefn_left_( x, __, ___, ____): # NOTE: translated from original Chinese comment.
        return x
    ...
    @staticmethod
    def v_com_gatefn_right_( __, y, ___, ____): # NOTE: translated from original Chinese comment.
        return y
...
class NotGateProver(_FirstOrderGateProver):
    ...
    @staticmethod
    def v_com_gatefn_(x, __, ___, rec): # pylint: disable=unused-argument
        if rec:
            rec.did_mul()
            rec.did_inv()
        return (1 - x) % Defs.prime
...
class NandGateProver(_SecondOrderGateProver):
    ...
    @staticmethod
    def v_com_gatefn_(_, __, xy, rec): # pylint: disable=unused-argument
        if rec:
            rec.did_add()
...
class NaabGateProver(_SecondOrderGateProver):
    ...
    @staticmethod
    def v_com_gatefn_(_, y, xy, rec): # pylint: disable=unused-argument
        if rec:
            rec.did_sub()
...
class PassGateProver(_FirstOrderGateProver):
    ...
    @staticmethod
    def v_com_gatefn_(x, __, ___, ____): # pylint: disable=unused-argument
        return x
...
# Python 3 compatible metaclass definition
...
class GateFunctions(metaclass=GateFunctionsMeta):
...
class GateFunctionsPC(metaclass=GateFunctionsMeta):
...
class GateFunctionsPVC(metaclass=GateFunctionsMeta):
...
class GateFunctionsVC(metaclass=GateFunctionsMeta):
