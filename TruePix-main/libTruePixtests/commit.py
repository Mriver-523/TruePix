...
def run_vector_helper(com):
    ...
    Jvec = [ com.gops.rand_scalar() for _ in range(0, com.gops.maxlen) ]
    Avec = [ com.gops.rand_scalar() for _ in range(0, com.gops.maxlen) ]
...
def run_vecpoly_helper(com):
    ...
    rvals = [ com.gops.rand_scalar() for _ in range(0, rlen) ]
    wvals = [ com.gops.rand_scalar() for _ in range(0, 2 ** rlen) ]
