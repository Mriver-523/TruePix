...
from libTruePix.circuitnizkvecwit import CircuitProverVecWitNIZK, CircuitVerifierVecWitNIZK
...
def run_rdl_test(nInBits, nCopies, nLayers, qStat):
    ...
    nInputs = 2 ** nInBits
    rdl = [ [ random.randint(0, nRDLInputs - 1) for _ in range(0, nInputs) ] for _ in range(0, nCopies) ]
